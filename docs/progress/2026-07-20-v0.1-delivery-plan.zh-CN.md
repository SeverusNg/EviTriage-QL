...
> **文档状态（2026-07-24 复核）**：这是 2026-07-20 制定的历史交付计划，
> 不是当前待办清单。Gate A–G 的 `v0.1.0` P0 范围已完成，稳定版
> `v0.1.0` 于 2026-07-23 提前发布，随后同日发布 `v0.2.0`。计划中的
> `v0.1.0-rc1` 没有单独创建 Git tag；本地候选验收通过后由稳定版发布
> 直接取代。第二宿主复现、签名、包索引发布以及长期科研能力仍未声称完成。
> 下方原始勾选框保留 2026-07-20 的计划基线，不回填为实时状态；逐项证据
> 见 [v0.1 交付日志](2026-07-27-v0.1.md)、[v0.1.0 发布说明](../releases/v0.1.0.md)
> 和 [v0.2.0 发布说明](../releases/v0.2.0.md)。
...
| 最终项目蓝图 | 完成 | [`project-blueprint-2026-07-20.zh-CN.md`](../requirements/project-blueprint-2026-07-20.zh-CN.md) |
| Codex master prompt | 完成 | [`codex-build-prompt-2026-07-20.zh-CN.md`](../requirements/codex-build-prompt-2026-07-20.zh-CN.md) |
| 最终推进表 | 完成 | 本文档 |
